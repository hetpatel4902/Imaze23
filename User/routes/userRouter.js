...
//events
router.route("/events").get(getAllEvents); //1.all the events 2.search filter 3.sort filter 4.specific fields
...
router.route("/certficates/:uid/:eid").get(getCertificate); //download certificate [:eid = event id]
