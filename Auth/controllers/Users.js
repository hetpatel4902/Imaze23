...
const registerUsers = async (req,res) => {
  const {name,email,password,college,enrno,qrlink}=req.body
   if(!email || !name || !password || !college || !enrno ){
...
const forgotPasswordUsers = async (req,res) => {
  ...
  const mailOptions = {
    from: '"IMAZE 23 " <ssip69@outlook.com>', // sender address (who sends)
...
module.exports = {
  registerUsers,forgotPasswordUsers,loginUsers
}